      ...
      >
        <div>
          ...
          <p className="mt-1 text-sm text-fg-muted">
            {member?.first_name ? `Hi ${member.first_name}, s` : "S"}et a
            4-to-6-digit PIN so you can sign back in on this device without
            Google every time. This PIN only works on this device and expires in
            30 days.
          </p>
        </div>

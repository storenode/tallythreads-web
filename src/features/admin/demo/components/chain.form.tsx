...
/** Renders the full editable profile for one member. */
...
/** Renders the editable fields for one store. */
...
export function CreateChainForm() {
  ...
  const [stores, setStores] = useState<ChainStoreDraft[]>(
    CHAIN_DEMO_DEFAULTS.stores,
  );

  const createDemo = useCreateChainDemo();
